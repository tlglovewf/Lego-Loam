...
//用于判断是否是地面点阈值 0（10 - sensorMountAngle ) 
extern const float sensorMountAngle = 0.0;
extern const float segmentTheta = 60.0/180.0*M_PI; // decrese this value may improve accuracy 点云分割时,角度跨度(判断是否为同一个物体)
extern const int segmentValidPointNum = 5;         //检查上下左右点数为分割依据
extern const int segmentValidLineNum = 3;          //检查上下左右线数为分割依据
